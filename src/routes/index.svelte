...
<section class="bg-black dark:bg-gray-800" >
    ...
    <div class="container px-6 py-16 mx-auto text-center">
        ...
        <div class="max-w-screen-xl mx-auto mt-20">
            <div class=" text-white container px-6 py-16 mx-auto text-center">Our future partners</div>
...
<div class= " bg-black relative flex flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-48 md:px-8 sm:max-w-xl md:max-w-full">
    <div class="z-0 flex justify-center h-full -mx-4 overflow-hidden lg:pt-24 lg:pb-16 lg:pr-8 xl:pr-0 lg:w-1/2 lg:absolute lg:justify-end lg:bottom-0 lg:left-0 lg:items-center">
      <img src="https://zzzap.io/image/zzzap.io.logo.png" class="object-cover object-right w-full h-auto lg:w-auto lg:h-full" alt="" />
    </div>
      ...
      <div class="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
        <div class="max-w-xl mb-6">
          ...
          <p class="text-base text-white md:text-lg">
            We will love to share good news with you \o/
          </p>
        </div>
        <form>
