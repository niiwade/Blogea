...
<section class="bg-black dark:bg-gray-800">
	<div class="container px-6 py-16 mx-auto text-center">
			...
			>
				<form class="flex flex-col md:flex-row">
					<input
						...
						class="flex-1 h-10 px-4 py-2 m-1 text-white placeholder-gray-400 bg-transparent border-none appearance-none dark:text-gray-200 focus:outline-none focus:placeholder-transparent focus:ring-0"
					/>
		...
		<div class="max-w-screen-xl mx-auto mt-20">
			<div class=" text-white container text-3xl px-6 py-16 mx-auto text-center">
				Our future partners
			</div>
...
<div
	class=" bg-black relative flex flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-48 md:px-8 sm:max-w-xl md:max-w-full"
>
	<div
	...
	>
		<img
			src="https://zzzap.io/image/zzzap.io.logo.png"
	...
	<div class="relative flex justify-end max-w-xl mx-auto xl:pr-32 lg:max-w-screen-xl">
		<div class="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
			<div class="max-w-xl mb-6">
				...
				>
					Get updates<br class="hidden md:block" />
					on our new endpoints
					<span class="inline-block text-deep-purple-accent-400">online</span>
				</h2>
				<p class="text-base text-white md:text-lg">We will love to share good news with you \o/</p>
			</div>
			<form>
				...
				<div class="flex items-center mt-4">
					<button
						type="submit"
						class="inline-flex items-center justify-center h-12 px-6 mr-6 font-bold tracking-wide text-gray-700 transition duration-200 rounded shadow-md bg-white hover:bg-black focus:shadow-outline focus:outline-none"
					>
						Subscribe
					</button>
					<a
	...
	>
		<div>
			<h2 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
				Build Your World Class Idea with our API's
			</h2>
			<p class="mt-4 text-white">Build your idea just got simpler with zzzap endpoints</p>
...
<section class="bg-black dark:bg-gray-900 lg:py-12 lg:flex lg:justify-center">
	<div
		class="bg-gray-900 dark:bg-gray-800 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg backdrop-blur-sm	backdrop-filter: blur(40px); "
	>
		<div class="lg:w-1/2">
			<div
		...
		<div class="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
			<h2 class="text-2xl font-bold text-white dark:text-white md:text-3xl">
				Build Your World Class <span class="text-blue-600 dark:text-blue-400"
					>Idea with our API's</span
				>
			</h2>
			<p class="mt-4 text-white dark:text-gray-400">
				Fast: The setup and responses are so fast and reliable it feels like magic.
			</p>
			<p class="mt-4 text-white dark:text-gray-400">
				Simple: Responses that are always structured and organized require less time to decipher
				giving you more time focus on the end goal.
			</p>
			<p class="mt-4 text-white dark:text-gray-400">
				No-code: The idea of moving, formatting and easily storing data without programming skills.
				If you can organize data, no-code gives you power to add new and ever expanding data and
				functionality to your list of resources.
			</p>
			<p class="mt-4 text-white dark:text-gray-400">
				A web URL that returns nicely formatted data (not a webpage). Use this data in your own
				website, web app, phone app, reports, analytics, no-code spaghetti or anything else you can
				wrap your mind around.
			</p>
			<div class="mt-8">
				<a
					href="/features"
					class="px-5 py-2 font-semibold text-black transition-colors duration-200 transform bg-gray-500 rounded-md hover:bg-gray-700"
					>Start Now</a
				>
			</div>
		</div>
